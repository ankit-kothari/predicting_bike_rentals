...
### Corelations Matrix
- Corelations between columns and the target variable ['cnt'] in this case <img src="https://github.com/ankit-kothari/data_science_journey/blob/master/github_images/bike2.png" width="40%"> 
